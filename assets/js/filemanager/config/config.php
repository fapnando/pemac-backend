...
$upload_dir = '../uploads/filemanager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../uploads/filemanager/'; // relative path from filemanager folder to upload folder (with final /)
...
*******************/
$aviary_active=true;
$aviary_key="j5kb5m2th9l2b626";
$aviary_secret="bf1ek6ifuyc413xd";
$aviary_version=3;
$aviary_language='en';
